...
import com.longoj.top.mapper.UserMapper;
...
import com.longoj.top.model.dto.user.UserQueryRequest;
import com.longoj.top.model.dto.user.UserUpdatePwdRequest;
import com.longoj.top.model.entity.Question;
import com.longoj.top.model.entity.User;
import com.longoj.top.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    @Override
    public boolean updateUserPwd(HttpServletRequest request, UserUpdatePwdRequest userUpdatePwdRequest) {
        // User loginUser = getLoginUser(request);
        User loginUser = UserContext.getUser();
        String encryptPassword = DigestUtils.md5DigestAsHex((SALT + userUpdatePwdRequest.getOldPwd()).getBytes());
